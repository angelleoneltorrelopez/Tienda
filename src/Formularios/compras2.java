...
public class compras2 extends javax.swing.JFrame {
   ...
   Connection cn= cc.conexion();
    ...
    void compra(){
       String InsertarSQL="INSERT INTO compras (num_comp,cod_prov,nom_prov,nit_prov,subtotal,iva,total,fec_comp) VALUES (?,?,?,?,?,?,?,?)";
    String numcomp=txtfac.getText();
    String codprov=txtcod.getText(); //captura los valores quee estan en los Textfield
    String nomprov=txtcliente.getText();
    String nitprov=txtnit.getText(); 
    ...
    try {
            ...
            Logger.getLogger(compras2.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    void detallecompra(){
        ...
        {
        String InsertarSQL="INSERT INTO detallecompra(num_comp,cod_pro,des_pro,cant_pro,pre_unit,pre_tot) VALUES (?,?,?,?,?,?)";
        String numcomp=txtfac.getText();
   ...
   txtfac.setEnabled(true);
        new buscarproveedorescompras().setVisible(true);
    ...
    private void btnproductosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnproductosActionPerformed
        ...
        new buscarproductoscompras().setVisible(true);
        }
...
if((txtcod.getText().equals("")) || (txtsubtotal.getText().equals("")))
  {
      JOptionPane.showMessageDialog(this, "No ingreso proveedor,productos o realice operacion");
  }
  else
  {
        String capcod="",capcan="";
    for(int i=0;i<compras2.tbdet.getRowCount();i++)
    {
        capcod=compras2.tbdet.getValueAt(i, 0).toString();
        capcan=compras2.tbdet.getValueAt(i, 3).toString();
