...
void habilitarnuevo(){
   ...
   void habilitar()
   {
    ...
    private void initComponents() {
        ...
        jButton1.setBounds(740, 260, 53, 23);
...
dispose();
    ...
    private void btnguardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnguardarActionPerformed
      ...
      //sentencias sql para insertar los datos en la base de datos
       String sql = "INSERT INTO `clientes`(`nombre_clie`, `nit_clie`, `direccion_clie`, `telefono_clie`, `email_clie`) VALUES ('"+nombre+"','"+nit+"','"+direccion+"','"+telefono+"','"+email+"')";         
    ...
    private void txtbuscarproveedorKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtbuscarproveedorKeyPressed
        ...
        String sql ="SELECT * FROM clientes WHERE nombre_clie LIKE '%"+nom+"%'";
        rs = con.Consulta(sql);
    ...
    private void btnactualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnactualizarActionPerformed
        ...
        //BOTON PARA MODIFICAR LOS DATOS DE UN CLIENTE EN LA BASE DE DATOS
    ...
    String email = txtemail.getText();
            ...
            try {
                ...
                // se crea la sentecia sql y se ejecuta para hacer la modificacion
                 String modifica = "UPDATE `clientes` SET `nombre_clie`='"+nombre+"',`nit_clie`='"+nit+"',`direccion_clie`='"+direccion+"',`telefono_clie`='"+telefono+"',`email_clie`='"+email+"' WHERE id_clie = '"+id2+"'";
