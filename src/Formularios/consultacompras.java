...
public class consultacompras extends javax.swing.JFrame {
   ...
   double total=0;
    ...
    void cargartodascompras()
    {
        ...
        String []titulos={"NUMERO","COD. PROVEEDOR","NOMBRE PROVEEDOR","NIT PROVEEDOR","SUBTOTAL","IVA","TOTAL","FECHA"};
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Consulta Compras Contado");
        jPanel1.add(jLabel1);
        jLabel1.setBounds(140, 20, 300, 29);
        ...
        btnbuscar.setBounds(480, 100, 80, 23);
        ...
        btneliminar.setBounds(480, 130, 80, 23);
    ...
    {
        consulta= "SELECT * FROM compras WHERE num_comp='"+num+"'";
    }
    ...
    detalle.setVisible(true);
        String numcomp=jTbuscar.getValueAt(filasele, 0).toString();
        String cod=jTbuscar.getValueAt(filasele, 1).toString();
        String nomprov=jTbuscar.getValueAt(filasele, 2).toString();
        ...
        detallecompra.txtfac.setText(numcomp);
        detallecompra.txtcod.setText(cod);
        detallecompra.txtnom.setText(nomprov);
        detallecompra.txtnit.setText(nit);
        detallecompra.txtsub.setText(subtotal);
        detallecompra.txtiva.setText(iva);
        detallecompra.txttot.setText(total);
        detallecompra.txtfecha.setText(fecha);
        
        DefaultTableModel model = (DefaultTableModel) detallecompra.tbdetalle.getModel();
        String ver="SELECT * FROM detallecompra WHERE num_comp='"+numcomp+"'";
        ...
        try {
                ...
                detallecompra.tbdetalle.setModel(model);
            } catch (SQLException ex) {
                Logger.getLogger(consultacompras.class.getName()).log(Level.SEVERE, null, ex);
            }
            }
    ...
    if(fila>=0)
    {
        String cod=jTbuscar.getValueAt(fila, 0).toString();
            try {
                PreparedStatement pst = cn.prepareStatement("DELETE FROM compras WHERE num_comp='"+cod+"'");
                pst.executeUpdate();
            } catch (SQLException ex) {
                Logger.getLogger(consultacompras.class.getName()).log(Level.SEVERE, null, ex);
            }
