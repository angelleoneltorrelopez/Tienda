 ...
 * @author julio
 */
public class buscarproductoscredito extends javax.swing.JFrame {
   ...
   double total=0;
    ...
    String comparar(String cod)
    {
        ...
        try {
            ...
            Logger.getLogger(buscarproductoscredito.class.getName()).log(Level.SEVERE, null, ex);
        }
        return cant;
...
try {
         DefaultTableModel tabladet = (DefaultTableModel)     ventascredito.tbdet.getModel();
    ...
    else
    {
        ...
        {
            Object com=ventascredito.tbdet.getValueAt(i,0);
            if(codins.equals(com))
            {
                j=i;
                ventascredito.tbdet.setValueAt(cant, i, 3);
                c=c+1;
        ...
        if(c==0)
        {
            ...
            ventascredito.tbdet.setModel(tabladet);
