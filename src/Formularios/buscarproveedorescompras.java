 ...
 * @author julio
 */
public class buscarproveedorescompras extends javax.swing.JFrame {
   ...
   String id;
   double total=0;
    public buscarproveedorescompras() {
    ...
    void mostrarproveedor(String valor)
    {
        ...
        try {
            ...
            Logger.getLogger(buscarproveedorescompras.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    try {
        ...
        else
        {
         ...
         compras2.txtcod.setDisabledTextColor(Color.blue);
         compras2.txtcod.setText(cod);
         compras2.txtcliente.setDisabledTextColor(Color.blue);
         compras2.txtcliente.setText(nom);
         compras2.txtnit.setDisabledTextColor(Color.blue);
         compras2.txtnit.setText(nit);
         compras2.txtdireccion.setDisabledTextColor(Color.blue);
         compras2.txtdireccion.setText(dir);
         this.dispose();
