 ...
 * @author julio
 */
public class pago_proveedores extends javax.swing.JFrame {
    ...
    void descontarcantidad(String codi,String can)
    {
       ...
       String cap="";
       double desfinal;
       String consul="SELECT * FROM compracredito WHERE  num_comp='"+codi+"'";
         try {
        ...
        String modi="UPDATE boleta SET total_pagar='"+desfinal+"' WHERE num_comp='"+codi+"'";
        try {
    ...
    {
        String[]titulos={"Codigo","Codigo Proveedor","Nombres","Total Proveedor","Fecha","Total a Pagar",} ;  
        String []Registros= new String[6];
        model=new DefaultTableModel(null,titulos);
        String Sql="SELECT * FROM compracredito WHERE CONCAT(cod_prov,nom_prov) LIKE '%"+valor+"%'";
        ...
        try {
             ...
             while(rs.next())
             {
                 ...
                 Registros[1]=rs.getString("cod_prov");  
                 Registros[2]=rs.getString("nom_prov");  
                 Registros[3]=rs.getString("pre_prov");  
            ...
            Logger.getLogger(pago_proveedores.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
   ...
   mostrarclientes(txtcliente.getText());
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
     ...
     String modi="UPDATE compracredito SET total_pagar='"+total+"' WHERE num_comp='"+bol+"'";
        try {
            PreparedStatement pst = cn.prepareStatement(modi);
            pst.executeUpdate();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(pago_proveedores.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
