 ...
 * @author julio
 */
public class consultaboleta extends javax.swing.JFrame {
   ...
   double total=0;
    ...
    void cargartodasboletas()
    {
        ...
        try {
            ...
            Logger.getLogger(consultaboleta.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Consulta Boleta");
        jPanel1.add(jLabel1);
    ...
    detalle.setVisible(true);
        ...
        detalleboleta.txtnom.setText(nomclie);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new consultaboleta().setVisible(true);
            }
        });
    }
