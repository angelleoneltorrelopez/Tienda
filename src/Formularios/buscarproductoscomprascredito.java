 ...
 * @author julio
 */
public class buscarproductoscomprascredito extends javax.swing.JFrame {
   ...
   String id;
   double total=0;
    public buscarproductoscomprascredito() {
    ...
    String comparar(String cod)
    {
        ...
        try {
            ...
            Logger.getLogger(buscarproductoscomprascredito.class.getName()).log(Level.SEVERE, null, ex);
        }
        return cant;
...
try {
         DefaultTableModel tabladet = (DefaultTableModel)     comprascredito.tbdet.getModel();
    ...
    else
    {
        ...
        {
            Object com=comprascredito.tbdet.getValueAt(i,0);
            if(codins.equals(com))
            {
                j=i;
                comprascredito.tbdet.setValueAt(cant, i, 3);
                c=c+1;
        ...
        if(c==0)
        {
            ...
            comprascredito.tbdet.setModel(tabladet);
