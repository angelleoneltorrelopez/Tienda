 ...
 * @author julio
 */
public class buscarproductoscompras extends javax.swing.JFrame {
   ...
   double total=0;
    ...
    String comparar(String cod)
    {
        ...
        try {
            ...
            Logger.getLogger(buscarproductoscompras.class.getName()).log(Level.SEVERE, null, ex);
        }
        return cant;
...
try {
         DefaultTableModel tabladet = (DefaultTableModel)     compras2.tbdet.getModel();
    ...
    else
    {
        ...
        {
            Object com=compras2.tbdet.getValueAt(i,0);
            if(codins.equals(com))
            {
                j=i;
                compras2.tbdet.setValueAt(cant, i, 3);
                c=c+1;
        ...
        if(c==0)
        {
            ...
            compras2.tbdet.setModel(tabladet);
