 ...
 * @author julio
 */
public class buscarclientescredito extends javax.swing.JFrame {
   ...
   double total=0;
    ...
    void mostrarclientes(String valor)
    {
        ...
        String Sql="SELECT * FROM clientes WHERE CONCAT(id_clie,nombre_clie,nit_clie,direccion_clie,telefono_clie) LIKE '%"+valor+"%'";
        ...
        try {
             ...
             while(rs.next())
             {
                 ...
                 Registros[2]=rs.getString("nit_clie");  
                 Registros[3]=rs.getString("direccion_clie");  
                 Registros[4]=rs.getString("telefono_clie");   
                 Registros[5]=rs.getString("email_clie");  
    ...
    private void initComponents() {
        ...
        jButton3.setBounds(420, 80, 110, 23);
    ...
    private void txtbuscarproveedorKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtbuscarproveedorKeyPressed
       mostrarclientes(txtbuscarproveedor.getText());
    ...
    try {
        ...
        else
        {
         ...
         ventascredito.txtcod.setDisabledTextColor(Color.blue);
         ventascredito.txtcod.setText(cod);
         ventascredito.txtcliente.setDisabledTextColor(Color.blue);
         ventascredito.txtcliente.setText(nom);
         ventascredito.txtnit.setDisabledTextColor(Color.blue);
         ventascredito.txtnit.setText(nit);
         ventascredito.txtdireccion.setDisabledTextColor(Color.blue);
         ventascredito.txtdireccion.setText(dir);
         this.dispose();
