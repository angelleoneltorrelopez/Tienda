...
public class buscarclientes extends javax.swing.JFrame {
   ...
   double total=0;
    ...
    private void initComponents() {
        ...
        jButton1.setBounds(423, 120, 130, 30);
        ...
        jButton3.setBounds(420, 80, 140, 30);

        getContentPane().add(jPanel1);
        jPanel1.setBounds(10, 10, 600, 390);

        setSize(new java.awt.Dimension(623, 453));
    ...
    try {
        ...
        else
        {
         ...
         ventas.txtcliente.setDisabledTextColor(Color.blue);
         ventas.txtcliente.setText(nom);
         ventas.txtnit.setDisabledTextColor(Color.blue);
         ventas.txtnit.setText(nit);
         ventas.txtdireccion.setDisabledTextColor(Color.blue);
